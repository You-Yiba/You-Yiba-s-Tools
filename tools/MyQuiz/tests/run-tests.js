...
// 加载测试文件
var testContent = fs.readFileSync(path.join(__dirname, 'csv-parser.test.js'), 'utf8');
eval(testContent);

// 运行测试
console.log('========================================');
console.log('MyQuiz CSV Parser 测试');
console.log('========================================\n');
